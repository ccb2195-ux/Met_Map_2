...
- My final analysis is in the donor_country_pivot_sorted.csv which contains my cleaned country data sorted by the gift/credit_line data from the original dataset.
...
- I experamented with many different methods of data cleaning and visualization, but the main dataset I use for the final visualization was cleaned in MET_map_explore.ipynb and credit_line_explore.ipynb.
